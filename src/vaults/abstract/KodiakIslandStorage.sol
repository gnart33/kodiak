...
abstract contract KodiakIslandStorage is ERC20, ReentrancyGuard, OwnableUninitialized, Pausable {
    ...
    event UpdateManagerParams(
        uint16 managerFeeBPS, address managerTreasury, uint16 compounderSlippageBPS, uint32 compounderSlippageInterval
    );
    ...
    function initialize(
        ...
        require(_managerFeeBPS <= 10_000, "managerFeeBps over max");
    ...
    function updateManagerParams(
        ...
        require(newSlippageBPS <= 10_000, "BPS");
        require(newManagerFeeBPS <= 10_000, "managerFeeBps over max");
