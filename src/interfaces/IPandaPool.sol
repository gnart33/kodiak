...
interface IPandaPool is IPandaStructs {
    ...
    function getTokensInPool(uint256 sqrtPa, uint256 sqrtPb, uint256 totalTokens, uint16 graduationFee)
        external
        view
        returns (uint256);
    ...
    function getAmountInBuy(uint256 amountOut)
        external
        view
        returns (uint256 amountIn, uint256 fee, uint256 sqrtP_new);
    function getAmountOutSell(uint256 amountIn)
        external
        view
        returns (uint256 amountOut, uint256 fee, uint256 sqrtP_new);
    function getAmountOutBuy(uint256 amountIn)
        external
        view
        returns (uint256 amountOut, uint256 fee, uint256 sqrtP_new);
    ...
    function sellTokens(uint256 amountIn, uint256 minAmountOut, address to)
        external
        returns (uint256 amountOut, uint256 fee);
    function sellTokens(uint256 amountIn, uint256 minAmountOut, address from, address to)
        external
        returns (uint256 amountOut, uint256 fee);
    function sellTokensForBera(uint256 amountIn, uint256 minAmountOut, address to)
        external
        returns (uint256 amountOut, uint256 fee);
    function buyTokens(uint256 amountIn, uint256 minAmountOut, address to)
        external
        returns (uint256 amountOut, uint256 fee);
    function buyTokens(uint256 amountIn, uint256 minAmountOut, address from, address to)
        external
        returns (uint256 amountOut, uint256 fee);
    function buyTokensWithBera(uint256 minAmountOut, address to)
        external
        payable
        returns (uint256 amountOut, uint256 fee);

    function initializeIncentives(address _incentiveToken, uint256 _incentiveAmount, address _incentiveContract)
        external;
